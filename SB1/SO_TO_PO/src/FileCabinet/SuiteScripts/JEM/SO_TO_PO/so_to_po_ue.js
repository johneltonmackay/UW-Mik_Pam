    ...
    (record, runtime, search, format, email) => {
        ...
        const afterSubmit = (scriptContext) => {
            ...
            if (scriptContext.type =='edit' || scriptContext.type == 'xedit' || scriptContext.type == 'create') {
                ...
                const OE_MISC_ITEM = 10409
                const OE_MISC_CHARGE = 10410
                const UNIDENTIFIED_SHIPPING_METHOD = 10408
                const SET_UP = 2677
        ...
        const createSalesOrder = (objSOData) => {
            ...
            try {
                ...
                objSOData.lineItems.forEach(data => {
                    ...
                    if (data.item == objSOData.oe_misc_charge || data.item == objSOData.oe_misc_item || objSOData.priceLevel == null){
                        objRecord.setCurrentSublistValue({
                            sublistId: 'item',
                            fieldId: 'rate',
